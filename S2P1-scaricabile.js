...
let num3 = 8
let num4 = 16
if ( num3 === 8 || num4 === 8 || num3 - num4 === 8 || num4 - num3 === 8 ) 
...
if (totalShoppingCart > 50 ) { console.log ( totalShoppingCart + totalWithoutShipping ) }
else console.log ( totalShoppingCart + shipping)
...
let totalWithSales = totalShoppingCart - (totalShoppingCart * 20 ) / 100
console.log ( totalWithSales) 
